...
public class MainForSpring {
    ...
    private static void processListCommand() {
        MemberListPrinter memberListPrinter = context.getBean(MemberListPrinter.class);
    ...
    private static void processInfoCommand(String[] s) {
        ...
        MemberInfoPrinter memberInfoPrinter = context.getBean(MemberInfoPrinter.class);
